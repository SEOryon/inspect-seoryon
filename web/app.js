...
(() => {
  ...
  const I18N = {
    ...
    de: {
      ...
      uc1_tag: "Agenturen", uc1_h3: "Live im Kundengespräch prüfen",
      uc1_p: "Öffne die Seite eines Interessenten mitten im Gespräch und zeig in Sekunden schnelle Verbesserungen auf – ohne Einrichtung, ohne Login.",
      uc2_tag: "In-House-Marketing", uc2_h3: "Vor dem Go-live absichern",
      uc2_p: "Finde fehlende Meta-Tags, defekte Links und falsche Canonicals, bevor eine Seite online geht.",
      uc3_tag: "Entwickler", uc3_h3: "Debuggen, ohne den Tab zu wechseln",
    ...
    fr: {
      ...
      uc2_tag: "Marketing interne", uc2_h3: "Vérifiez avant de mettre en ligne",
      uc2_p: "Repérez les balises meta manquantes, les liens cassés et les mauvaises canoniques avant qu’une page ne parte en ligne.",
